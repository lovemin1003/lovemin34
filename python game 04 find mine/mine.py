# -*- coding: utf-8 -*-
"""
Created on Sun Feb  2 16:22:43 2020
...
while int(A) > 90: # 지뢰수 설정 가능
    A = input("최대 지뢰 수(90개 까지):")
    if int(A) > 90:
        print("지뢰는 90개까지만 설정 가능합니다.")
...
def main(): # 메인 루틴
    ...
    message_clear = largefont.render("clear",True,(0,0,200))
    message_over = largefont.render("game over",True,(0,110,200))
    ...
    while True:
            ...
            for xpos in range(WIDTH):
                ...
                if tile == EMPTY or tile == BOMB:
                    ...
                    if game_over and tile == BOMB:
                        pygame.draw.ellipse(SURFACE,(190,190,190),rect)
        ...
        for index in range(0, WIDTH*SIZE, SIZE):
            pygame.draw.line(SURFACE, (90,90,90), (index , 0),(index, HEIGHT*SIZE))
        for index in range(0, HEIGHT*SIZE, SIZE):
            pygame.draw.line(SURFACE, (90,90,90), (0 , index), (WIDTH*SIZE, index))
