...
public class optionalex1 {
	...
	public static void main(String[] args) 
	{
		...
		Optional<String> optStr = Optional.of("sonata");
...
//		System.out.println(optInt2.getAsInt()); //NoSuchElementException
		...
		Optional<String> opt2 = Optional.empty(); //后 按眉 积己
	 ...
	 static int optStrToInt(Optional<String> of, int i) {

		 try {
			 return of.map(Integer::parseInt).get();
		 }
		 catch(Exception e)
		 {
			 return i;
