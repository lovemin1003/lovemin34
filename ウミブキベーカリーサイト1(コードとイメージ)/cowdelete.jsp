...
<form method="post" action="cowdeleteaction.jsp?userid=<%=userid%>">
<h3 style="text-align:center;"> 会員脱退 画面</h3>

<div class="form-group">
<input type="password" class="form-control" placeholder="パスワード" name="userpassword">
</div>
<input onclick="return confirm('本当に　脱退しますか？')"   type="submit" class="btn btn-promary form-control" value="会員脱退">
</form> 
</div>
</div>
<div class="col-lg-4"></div>
