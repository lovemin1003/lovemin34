...
<!-- 닉네임으로 글 검색창 -->
<form  class="navbak-form" method="post" action="searchaction.jsp">
...
<!-- 제목으로 글 검색창 -->
<form  class="navbak-form" method="post" action="titlesearchaction.jsp">
<div class="form-group">
...
<!-- 글내용으로 글 검색창 -->
<form  class="navbak-form" method="post" action="contentsearchaction.jsp">
<div class="form-group" >
...
{
%>
<a  href="bbs.jsp?pagenumber=<%= 1 %>"class="btn btn-success btn-arrow-left" style="background-color:#900020;">이전</a>
<%
} 
%>
<%
...
{
%>
<a  href="bbs.jsp?pagenumber=<%=  pagenumber-5 %>"class="btn btn-success btn-arrow-left" style="background-color:#900020;">이전</a>
<%
} 
%>
...
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber%>(현재 목록)</a>
<%
}
%>
...
if(bbsdao.nextpage(pagenumber + 2)) 
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber + 2 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber + 2 %></a>
<%
}
if(bbsdao.nextpage(pagenumber + 3)) 
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber + 3 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber + 3 %></a>
<%
}
if(bbsdao.nextpage(pagenumber + 4)) 
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber + 4 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber + 4 %></a>
<%
}
if(bbsdao.nextpage(pagenumber + 5)) 
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber + 5 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">다음</a>
<%
}
...
{
%>
<a  href="bbs.jsp?pagenumber=<%= 1 %>"class="btn btn-success btn-arrow-left" style="background-color:#900020;">最初の目録</a>
<%
} 
%>
...
{
%>
<a  href="bbs.jsp?pagenumber=<%=  pagenumber-cn %>"class="btn btn-success btn-arrow-left" style="background-color:#900020;">以前</a>
<%
} 
%>
<!--  전 앞쪽 목록 출력
...
<a href="bbs.jsp?pagenumber=<%= pagenumber - a %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber - a %></a>
<%
}
%>
...
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;"><%= pagenumber%>(現在の目録)</a>
<%
}
%>
...
{
%>
<a href="bbs.jsp?pagenumber=<%= pagenumber + cn %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">次の目録</a>
<%
}
%>
...
{
%>
<a href="bbs.jsp?pagenumber=<%= wn-1 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">最後の目録</a>
<%
}
%>
<%
