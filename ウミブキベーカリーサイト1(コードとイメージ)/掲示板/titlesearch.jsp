...
ArrayList<bbs> list5 = bbsdao.getlist5(pagenumber,search);
...
<td><a href="view.jsp?bbsid=<%= list5.get(i).getBbsid() %>"><%= list5.get(i).getBbstitle().replaceAll(" ","&nbsp").replaceAll("<", "&lt").replaceAll(">", "&gt").replaceAll("\n", "<br>")  %></a></td>
...
{
%>
<a href="titlesearch.jsp?pagenumber=<%= pagenumber + 1 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">後 <%=d %>個</a>
<%
}
%>
