...
<td><a href="view.jsp?bbsid=<%= list2.get(i).getBbsid() %>"><%= list2.get(i).getBbstitle().replaceAll(" ","&nbsp").replaceAll("<", "&lt").replaceAll(">", "&gt").replaceAll("\n", "<br>")  %></a></td>
<td><%= list2.get(i).getUserid() %></td>
<td><%= list2.get(i).getBbsdate() %></td>
<td><%= list2.get(i).getHit() %></td>
<td><%=bbs1dao.commentcount(list2.get(i).getBbsid()) %></td>
...
{
%>
<a href="search.jsp?pagenumber=<%= pagenumber + 1 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">次 <%=d %>個</a>
<%
}
%>
