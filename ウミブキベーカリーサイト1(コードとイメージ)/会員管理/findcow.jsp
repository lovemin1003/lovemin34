...
body
{
 background-image: url("커피와 겨울.jpg");
...
<form method="post" action="findcowaction.jsp">
<h3 style="text-align:center;">ID探し 画面</h3>
...
<input type="submit" class="btn btn-promary form-control" value="ID探し">
</form> 
</div>
</div>
<div class="col-lg-4"></div>
