...
<td><a href="shoppingview.jsp?bbsid=<%= list2.get(i).getBbsid() %>"><%= list2.get(i).getBbstitle().replaceAll(" ","&nbsp").replaceAll("<", "&lt").replaceAll(">", "&gt").replaceAll("\n", "<br>")  %></a></td>
...
{
%>
<a href="search.jsp?pagenumber=<%= pagenumber + 1 %>"class="btn btn-success btn-arrow-left" style="background-color:#909020;">後 <%=d %>個</a>
<%
}
%>
